        ...
        <div className="grid gap-6">
          {filteredIssues.map((issue) => (
            ...
            >
              ...
              {issue.image && (
                <img src={`http://localhost:5000/uploads/${issue.image}`} alt="Issue" className="mt-2 rounded w-32 border" />
              )}
            </div>
          ))}
        </div>
      ...
      {selectedIssue && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-2xl w-full relative">
            ...
            <h2 className="text-2xl font-bold mb-2 text-[#124E66]">{selectedIssue.title}</h2>
            ...
            <p className="text-sm text-gray-600 mb-3">Reported by: {selectedIssue.reporterId?.username || selectedIssue.reporterId}</p>
            {selectedIssue.image && (
              <img
